...
Ushbu usul ingliz tilidan [Mansur Isakov](https://github.com/MansurIsakov) tomonidan tarjima qilingan. Original [Oz Nova](https://twitter.com/oznova_) va [Myles Byrne](https://twitter.com/quackingduck) tomonidan yaratilgan va https://teachyourselfcs.com/ havolasi orqali mavjud.\_
...
| --------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- | --------------------------------- |
| **[Dasturlash](#dasturlash)**                                         | Rekursiya darajasidagi biror narsani "to'liq tushunmaydigan" odam bo'lmaslik uchun.                                                                       | _Kompyuter dasturlarining tuzilishi va talqini_               | Brian Harvey’s Berkeley CS 61A    |
| **[Kompyuter arxitekturasi](#kompyuter-arxitekturasi)**               | Kompyuter qanday ishlashini bilmasangiz, kod bilan nima qilish va qilmaslik haqidagi tushunchangiz yuzaki bo'ladi.                                        | _Kompyuter arxitekturasi va kompyuter tizimlarini loyihalash_ | Berkeley CS 61C                   |
| **[Algoritmlar va ma'lumotlar tuzilmalari](#algoritmlar-tuzilmalar)** | Agar siz stack, navbat, yog'och, grafikalar kabi asosiy ma'lumotlar tuzilmalaridan qanday foydalanishni bilmasangiz, qiyin muammolarni hal qila olmaysiz. | _Algoritmlar. Rivojlanish qo'llanmasi_                        | Steven Skiena’s lectures          |
...
| **[Tillar va kompilyatorlar](#tillar-va-kompilyatorlar)**             | Agar tillar va kompilyatorlar qanday ishlashini tushunsangiz, yaxshiroq kod yozishingiz va yangi tillarni yanada samarali o'rganishingiz mumkin.          | _Kompilyatorlar: printsiplar, texnologiyalar va vositalar_    | Alex Aiken’s course on Lagunita   |
| **[Taqsimlangan tizimlar](#taqsimlangan-tizimlar)**                   | Bugungi kunda _ko'pgina_ tizimlar taqsimlangan tizimlardir.                                                                                               | _Qatilgan tizimlar. Printsiplar va paradigmalar_              | MIT 6.824                         |
